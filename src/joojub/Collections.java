 ...
 * 경우에 따라 원래의 유형으로 변환해야 하는 번거러움이 존재하고 오류가 발생할 수 있는 가능성이 존재
 */
...
public class Collections {
    public static void main(String[] args) {
        ...
        // 일반적으로 배열은 동일한 유형의 자료들을 저장하는 자료구조
        // 하지만 배열의 유형을 Object 로 선언하면 온갖 종류의 데이터들을 저장할 수 있음
        ...
        // 우리에서 동물을 하나씩 빼냄
        // 배열에 저장된 데이터를 빼낼때는 적절한 형변환이 필요함
        ...
        // 컬렉션 프레임워크에서 제공하는 동적배열(1차배열만 가능)
        // 동적배열의 자료형은 기본 Object
        Zoo2.add(new Tiger());
        Zoo2.add(new Lion());
        Zoo2.add(new Zebra());

        //t1 = Zoo2.get(0); 동적배열을 사용했지만 앞의 경우와 동일하게 형변환시 오류발생;

        //Generic 을 이용하면 데이터의 타입을 통일시켜
        ...
        t1 = zoo3.get(0); //자동으로 형변환 되기 때무넹 오류없이 처리가능
