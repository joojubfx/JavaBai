...
public class OOPCasting {
    public static void main(String[] args) {
        ...
        이처럼 상속관계에 있는 클래스간의 객체 생성시 자식클래스타입 객체가
        부모클래스타입의 객체로 선언하는 경우 업캐스팅 upcasting 이라 함
        */
        ...
        이처럼 상속관계에 있는 클래스간의 객체 생성시 부모클래스타입의 객체를 자식클래스타입의 객체로 선언하는 경우
        다운캐스팅 downcasting 이라 함
        단 컴파일시에는 오류가 나지 않지만
        실행시 오류발생!
        */
        ...
        실행에는 아무 문제 없음
        =>Unit 변수는 Marine 객체를 Unit 객체로 만든것
